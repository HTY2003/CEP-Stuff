...
class CHashTable:
    ...
    It also uses the FNV1 hash, designed for speed and randomness to prevent
    ...
    def __chain(self,index,element):
        ...
        """
        #Adds element to deque in index
    ...
    def __search(self,index,element):
        ...
        """
        #Search through any non-empty elements in the index
        if self._data[index] is not None:
    ...
    def used(self):
        ...
        number of non-empty chains in the array which the elements are stored in.
    ...
    def remove(self,element):
        ...
        index = self.__fnv1(element)
        try:
            #removes element from the deque in the index
