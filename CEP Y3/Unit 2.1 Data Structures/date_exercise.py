...
class Date :
    ...
    def __init__( self, month, day, year ):
        ...
        assert self._isValidGregorian( month, day, year ), \
         ...
         # as the mathematical definition. Mathematically: (3-14)/12 = -11/12 = 0
         # but in python -11 // 12 = -1.
        tmp = 0
        if month < 3 :
            tmp = -1
    ...
    def __eq__( self, otherDate ):
        #type in your implementation here
        pass
    ...
    def _isValidGregorian(self, m, d, y):
        return True #left as an exercise for the reader
